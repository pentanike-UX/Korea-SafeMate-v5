...
import { Clock, Footprints, Gauge, MapPin, Sun } from "lucide-react";
...
export function RouteSummaryCard({
  ...
  return (
    <Card className={cn("border-border/60 gap-0 overflow-hidden rounded-2xl py-0 shadow-[var(--shadow-md)]", className)}>
      <div className="border-border/60 border-b bg-white/95 px-5 py-4 sm:px-6 sm:py-4">
